		...
		<v-row justify="center">
			<v-col cols="12" md="10">
				<v-card class="mx-auto" elevation="2">
					...
					<p class="mb-1">
								<b>float()</b> - змінні цього типу можуть набувати як цілих, так і дробових значень;
						</p>
						<p class="mb-1">
								<b>int()</b> - змінні цього типу можуть набувати тільки цілих значень;
						</p>
						<p class="mb-1">
								<b>str()</b> - змінні цього типу можуть набувати тільки текстових значень;
						</p>
						<p class="mb-1">
								<b>print()</b> - виводить текст на екран;
						</p>
						<p class="mb-1">
								<b>input()</b> - зчитує введення з клавіатури;
						</p>
						<p class="mb-6">
								<b>round()</b> - округлює число до найближчого цілого.
						</p> 
						<h2 class="text-h5 my-2">Приклад програми</h2>
						<p class="mb-1">На 1 м<sup>2</sup> площі клумби, що має довжину а та ширину b, припадає 4 саджанці.
...
is_student = True   # логічне значення</code></pre>
						...
						<p class="mb-1">Імена змінних у мові програмування Python можуть містити:
						</p>
						<v-list class="mb-6">
							...
							<v-list-item prepend-icon="mdi-format-letter-case" title="Спеціальні символи" subtitle="Імена змінних не можуть містити спеціальні символи, крім нижнього підкреслення (_)"></v-list-item>
						</v-list> 
